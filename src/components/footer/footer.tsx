            ...
            <div className="container mx-auto px-[36px]">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pb-10">
                    ...
                    <div className="space-y-3">
                        ...
                        <a href="#" className="block hover:underline">International Airlines</a>
                        <a href="#" className="block hover:underline">Popular Destinations</a>
                        <a href="#" className="block hover:underline">Join Us</a>
                    </div>
                    ...
                    {/* Column 3 */}
                    <div className="space-y-3">
                        <a href="#" className="block hover:underline">Nix Hospital</a>
                        <a href="#" className="block hover:underline">Nix Study Abroad</a>
                        <a href="#" className="block hover:underline">Nixtour Charters</a>
                        <a href="#" className="block hover:underline">Nixtour Blogs</a>
                    </div>
                </div>
                    ...
                    <div className="flex gap-[92px]">
                        ...
                        <div className="">
                            ...
                            <p className="text-sm max-w-3xl">
                                ...
                                India's fastest-emerging online travel website and have a customer-centric Approach. We have
                                been serving the fields since 2015. We also specialize in special student Airfares. Each student
                                is our top priority because we offer them an extra luggage allowance and discounted airfare up
                                to 15%-20%, extra luggage, and no-cost rescheduling; however, such offers depend on the
